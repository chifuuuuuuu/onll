...
//TIME
global.waktu = `${date}`
global.namabot = '⫹⫺ KyuuBotz-V3 Beta'
global.v = '-'   
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `ᴛ ɪ ᴍ ᴍ ᴇ : ${wktuwib}`
// Sticker WM
global.packname = `☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Justpann`
...
//--------[WATERMARK]
global.wm = 'Justpann 汉 」' //Main WM
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘バージニティハンター˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ KyuuBotz-V3 Beta'
global.md = 'KyuuBotz-V3 Beta'
//-----[OWNER]
...
global.footer = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ ฅ˘ Kyuu`s botz˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
/*============== SOCIAL ==============*/
global.sig = 'https://instagram.com/just_pannn'
global.sgh = 'https://github.com/Justpannstoree'
global.sgc = 'https://chat.whatsapp.com/CWHwGiWqT4U8b4uRwUd0ot'
global.sdc = 'https://pannstorebot.fazlink.co/'
global.snh = 'https://linktr.ee/justpann'
global.sfb = 'https://www.facebook.com/pannajah'
global.syt = 'https://youtube.com/@PannBotzz'
//====== Url Template Buttons ======//
global.dtu = 'ᴅᴏɴᴀᴛᴇ'
global.urlnya = "https://pnggilajacn.my.id/contacts"
//========== callButtons ==========//
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '+62 831-9632-0578'
